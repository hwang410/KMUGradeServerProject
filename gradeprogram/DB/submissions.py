...
class Submissions (Base) :
    ...
    problemId =Column (INTEGER (unsigned =True), ForeignKey (SubmittedFiles.problemId, onupdate ="CASCADE"), primary_key =True, autoincrement =False, nullable = False)
    courseId =Column (VARCHAR (10), ForeignKey (SubmittedFiles.courseId, onupdate ="CASCADE"), primary_key =True, nullable = False)
    ...
    sumOfSubmittedFileSize =Column (INTEGER (unsigned =True), nullable =False)
