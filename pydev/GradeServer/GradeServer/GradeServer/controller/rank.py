...
페이지 별로 보여줌
"""    
@GradeServer.route('/rank/<sortCondition>/page<pageNum>')
@login_required
def rank(sortCondition, pageNum):
    ...
    try :
        ...
        return render_template('/rank.html', rankMemberRecords =get_rank (submissions, sortCondition), pages =get_page_pointed (int(pageNum), count))
