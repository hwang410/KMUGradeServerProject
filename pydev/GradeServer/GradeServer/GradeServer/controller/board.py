...
def board(activeTabCourseId, pageNum):    
    try:
        ...
        articlesOnBoard = join_courses_names(# get TabActive Articles
                ...
                # 과목 공지글    
        try:  
            articleNoticeRecords = get_page_record((select_sorted_articles(activeTabCourseId = articlesOnBoard,
...
def read(activeTabCourseId, articleIndex, error = None):
    ...
    if request.method == 'GET':
        ...
        for form in request.form:
            ...
            if form == 'articleLike':
                ...
                if not isPostLike:
                    ...
                    LIKE_INCREASE = 1
                                    ...
                                    # 다시 좋아요 누를 때
                    if isPostLike == ENUMResources().const.TRUE:
                        # Counting +1
                        LIKE_INCREASE = 1
                ...
                break 
            # Commit Modify
            elif 'modifyConfirmArticleComment' in form:
            ...
            elif 'modifyArticleComment' in form:
               
                idIndex = len('modifyArticleComment')
