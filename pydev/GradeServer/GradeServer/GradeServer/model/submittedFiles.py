...
class SubmittedFiles (Base) :
    ...
    problemId =Column (INTEGER (unsigned =True), ForeignKey (RegisteredProblems.problemId, onupdate ="CASCADE"), autoincrement =False, primary_key =True, nullable =False)
    courseId =Column (VARCHAR (20), ForeignKey (RegisteredProblems.courseId, onupdate ="CASCADE"), primary_key =True, nullable =False)
